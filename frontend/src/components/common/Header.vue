    ...
    <div class="header">
        <div class="inner">
            <nav class="navbar navbar-expand-lg navbar-light bg-white fixec-top">
                ...
                <div id="navbarname" class="animate__animated animate__bounce"><a class="navbarname" href="/"><h4>싸피로그</h4></a></div>
            ...
            <div class="collapse navbar-collapse d-flex justify-content-end" id="navbarSupportedContent">
                    ...
                    <span v-if="this.$store.state.isLogin===false" class='d-flex justify-content-end'>
            ...
            <nav id="router">
            <ul>
                <li class="routerlist"><router-link class="routerlink" :to="{ name:'List' }">목록</router-link></li>
                <li class="routerlist"><router-link class="routerlink" :to="{ name:'MyPage' }">MyPage</router-link></li>
                <li class="routerlist"><router-link class="routerlink" :to="{ name:'VisitCreate' }">방명록</router-link></li>
            </ul>
            </nav>
        </div>
    </div>
